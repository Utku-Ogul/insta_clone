...
class User::RegistrationsController < Devise::RegistrationsController
  ...
  #Eğer user_name gibi ek alanları formda kullanmak ve bu bilgileri veritabanında saklamak istiyorsanız, configure_permitted_parameters metodunu doğru şekilde yapılandırmanız gerekir.
end
